...
export const services = [
  {
    ...
    icon: 'FiCode',
    // BUG on live site: this section's body text was an exact duplicate of "Mobile App
    // Development" below. Left as-is per client instruction (fix later) — flagged clearly.
    ...
    benefits: ['Tailored to your exact workflow', 'Built to scale as you grow', 'Full ownership of your codebase'],
    isPlaceholder: true,
    placeholderNote: 'Duplicate copy bug carried over from live site — needs a real, distinct description.',
  },
  {
    ...
    icon: 'FiSmartphone',
    body: 'We offer custom app development services to help businesses bring their ideas to life through powerful and intuitive mobile applications. Our team develops high-quality apps for both Android and iOS platforms, focusing on seamless performance, attractive user interfaces, and reliable functionality. Whether you\u2019re launching a new product or improving internal processes, we build scalable and secure mobile solutions tailored to your goals.',
    benefits: ['Native-quality performance', 'Android & iOS from one codebase', 'Polished, intuitive UI'],
    isPlaceholder: false,
  },
  {
    ...
    benefits: ['Fully responsive, every device', 'Fast load times by default', 'Built for SEO from day one'],
    isPlaceholder: false,
  },
  {
    ...
    benefits: ['Secure by design', 'Scales with your data growth', 'SQL or serverless — your choice'],
    isPlaceholder: false,
  },
  // The following are named in the project brief but had no captured description yet
  // (services page 2/2 wasn't screenshotted). Draft descriptive copy provided — review before launch.
  {
    ...
    benefits: ['Built for multi-team operations', 'Enterprise-grade reliability', 'Long-term scalability'],
    isPlaceholder: true,
  },
  {
    ...
    benefits: ['Built around your workflow', 'Real-time data visibility', 'Role-based access control'],
    isPlaceholder: true,
  },
  {
    slug: 'landing-pages',
    ...
    benefits: ['Optimized for conversion', 'Fast to launch', 'Mobile-first design'],
    isPlaceholder: true,
  },
  {
    slug: 'ui-ux-design',
    ...
    benefits: ['Grounded in user research', 'Prototype before you build', 'Accessible by design'],
    isPlaceholder: true,
  },
  {
    ...
    benefits: ['Proactive monitoring', 'Regular security updates', 'Fast turnaround on fixes'],
    isPlaceholder: true,
  },
  {
    ...
    benefits: ['Cross-device test coverage', 'Automated + manual QA', 'Fewer bugs in production'],
    isPlaceholder: true,
  },
  {
    ...
    benefits: ['Less manual busywork', 'Fewer human errors', 'Time back for your team'],
    isPlaceholder: true,
  },
  {
    ...
    benefits: ['Data-driven targeting', 'Cross-channel campaigns', 'Clear performance tracking'],
    isPlaceholder: true,
  },
  {
    slug: 'video-editing',
    ...
    benefits: ['Platform-ready formats', 'Fast turnaround', 'On-brand visual style'],
    isPlaceholder: true,
  },
  {
    ...
    benefits: ['Simplifies complex ideas', 'Engaging, shareable format', 'Consistent brand motion'],
    isPlaceholder: true,
  },
  {
    slug: 'brand-identity',
    ...
    benefits: ['Consistent brand presence', 'Complete identity system', 'Professional first impression'],
    isPlaceholder: true,
  },
  {
    slug: 'graphic-design',
    ...
    benefits: ['On-brand every time', 'Print & digital ready', 'Fast creative turnaround'],
    isPlaceholder: true,
  },
  {
    ...
    benefits: ['Consistent posting cadence', 'Cross-platform strategy', 'Audience growth focus'],
    isPlaceholder: true,
  },
  {
    ...
    benefits: ['Written to rank', 'Clear, readable copy', 'Keyword-researched content'],
    isPlaceholder: true,
  },
]
