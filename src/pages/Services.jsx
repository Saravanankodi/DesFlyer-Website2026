...
/* ================================================================
   ...
   Uses reliable Unsplash CDN images instead of LoremFlickr.
   Every service has its own relevant image, while the title/content
   still determines which service category is selected.
================================================================ */
...
function getServiceImages(service, index = 0) {
  ...
  /*
    ...
    If a category contains two different images,
    both can be used as primary/fallback.
  */
...
function ServiceImage({ service, index, isActive }) {
  ...
  const handleImageError = () => {
    ...
    /*
      Final fallback only if the exact supplied image
      cannot be loaded.
    */
...
function ServiceTile({
  ...
  const handleTouchEnd = (
    ...
    /*
     * Don't select a card if this was
     * a horizontal grid swipe.
     */
  ...
  transition={{
    // Smooth card expansion + surrounding card movement
    layout: {
...
<a href="#exp">
      ...
      >
        ...
        <div className="relative mx-auto max-w-[1400px] -mt-28"
        id="exp">
          {/* HEADER */}
