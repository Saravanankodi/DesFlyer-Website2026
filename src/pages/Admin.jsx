  ...
  return (
    <div className="min-h-screen flex items-center justify-center px-6 bg-[var(--bg)]">
      ...
      >
        ...
        <h1 className="font-display font-semibold text-2xl mt-5 text-[var(--fg)]">
          Admin Login
        </h1>

        <p className="text-sm text-[var(--fg)]/50 mt-1">
...
function AdminShell() {
  const { user, isAuthed, loading } = useAdminAuth()
...
export default function Admin() {
  return (
    <>
      <Seo
        title="Admin"
        description="DesFlyer admin panel."
        path="/admin"
      />
