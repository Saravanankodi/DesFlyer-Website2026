...
export default function JobDetailsPage() {
  ...
  async function handleDelete(id) {
    const confirmed = window.confirm(
      'Delete this job opening? This will remove it from the website immediately.'
    )
  ...
  return (
    <div className="p-6 lg:p-10">
      ...
      <p className="text-sm text-[var(--fg)]/50 mb-8">
        Changes here sync live to the public Jobs page.
      </p>
          ...
          {openings.map((item) => (
            ...
            >
              ...
              <p className="text-xs text-[var(--fg)]/50 mt-1">
                {item.department} &middot; {item.experience}
              </p>
              ...
              {item.salary && (
                <p className="text-xs text-[var(--fg)]/50 mt-2">
                  {item.salary}
                </p>
              )}
